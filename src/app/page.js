...
import HeroScrollHome from "@/components/home/Introduction";
...
export default function Home() {
  ...
  return (
    <div className="relative flex flex-col min-h-screen dark:bg-zinc-950 bg-white">
      ...
      <div className="flex flex-col items-center justify-center -my-44 min-h-screen overflow-hidden relative z-10">
        <HeroScrollHome />
      </div>
